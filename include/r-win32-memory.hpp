...
namespace r_win32 {
    ...
    r_external const r_size memory_page_size              (r_void);
    r_external const r_size memory_large_page_size        (r_void);
    r_external const r_size memory_allocation_granularity (r_void);
    r_external const r_b8   memory_large_pages_enabled    (r_void);
    r_external const r_b8   memory_large_pages_set        (const r_b8 set_value);
    ...
    r_external r_void   memory_decommit (const r_memory start, const r_size size);
    r_external r_void   memory_release  (const r_memory start, const r_size size);
